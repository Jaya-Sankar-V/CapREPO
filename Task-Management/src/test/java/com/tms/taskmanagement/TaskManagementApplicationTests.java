...
//
//        taskdto.setTaskName("TicketBooking IRTC");
//        taskdto.setTaskDescription("desc for Ticket Booking");
//        taskdto.setProjectId(1L);
//        taskdto.setTaskStatus("pending");
//        taskdto.setUserId(2L);
//        taskdto.setTaskEnd(new Date(date.parse("2024-09-09").getTime()));
//        taskdto.setTaskStart(new Date(date.parse("2024-09-01").getTime()));
//        taskdto.setTaskId(1L);
//
//        TaskDTO response = restTemplate.postForEntity(getBaseUrl().concat("create"), taskdto, TaskDTO.class).getBody();
//
//        assertNotNull(response);
//        assertEquals("TicketBooking IRTC", response.getTaskName());
//    }

//    @Test
//    void testGetTaskByTid() {
//        ResponseEntity<TaskDTO> response = restTemplate.getForEntity(getBaseUrl().concat("gettask/{tid}"), TaskDTO.class, 4L);
//        assertNotNull(response.getBody());
//        assertEquals("TicketBooking IRTC", response.getBody().getTaskName());
//    }
